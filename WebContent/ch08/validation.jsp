...
<body>
	...
	<!--
		...
		부분들이 발견되어 새롭게 만들어진 태그가 button 태그인데, input type button/submit은 end태그로서 활용이 어려워
		(</input>) CSS를 활용하여 또는 태그들을 활용하여 버튼을 꾸미는데 제약이 많이 걸린다. button 태그는 몸체를 꾸밀 수 있다는 장점이  있어
		...
		- onsubmit = "return 함수명" 으로 사용
			> return을 부여하는건 해당 함수가 실행될 때, 정상처리면 true/ 값의 필터에 의해 처리결과가 비정상적일 땐 false를 리턴
